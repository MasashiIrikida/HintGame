...
- ご利用時のトラブル等につきましては、一切の責任を負いかねます事を<br>
  ご了承ください
...
- さらなる対策として、村人をニートに指定して、職業ブロックがあっても職に就かなくさせ、取引インベントリも
  開けないようにして、村人の動きを奪わずにヒント集を返せるようになった
...
　- `resouces` ファイルの `mybatis-config.xml` の `password` をご自身が設定したものに
